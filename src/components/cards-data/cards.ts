...
export const cardRoutes: CardMeta[] = [
  ...
  { slug: "command-palette-card", href: "/components/cards/command-palette-card", title: "Command Palette", category: "Forms", icon: Command, accent: "#0ea5e9", animation: "Fuzzy search + keyboard nav + recent + highlight", source: "more" },
  ...
  { slug: "aurora-bento-sidebar-card", href: "/components/cards/aurora-bento-sidebar-card", title: "Aurora Bento Sidebar", category: "Sidebar", icon: PanelLeft, accent: "#6366f1", animation: "Bento grid nav · mixed-size tiles · colored active state · staggered entrance · Apple TV style", source: "more" },
  { slug: "rail-dock-sidebar-card", href: "/components/cards/rail-dock-sidebar-card", title: "Rail Dock Sidebar", category: "Sidebar", icon: PanelLeft, accent: "#06b6d4", animation: "macOS dock · icon magnification on hover · tooltip labels · active dot indicator · dark gradient bg", source: "more" },
  ...
  { slug: "compact-pill-sidebar-card", href: "/components/cards/compact-pill-sidebar-card", title: "Compact Pill Sidebar", category: "Sidebar", icon: PanelLeft, accent: "#ec4899", animation: "Ultra-minimal pill rail · icons expand to pills on hover · spring width animation · dark bg", source: "more" },
  { slug: "dual-panel-sidebar-card", href: "/components/cards/dual-panel-sidebar-card", title: "Dual Panel Sidebar", category: "Sidebar", icon: PanelLeft, accent: "#3b82f6", animation: "Two-level expandable · parent categories expand to children · smooth height animation · collapsed dot mode", source: "more" },
  ...
  { slug: "agent-workflow-builder-card", href: "/components/cards/agent-workflow-builder-card", title: "Agent Workflow Builder", category: "AI", icon: Sparkle, accent: "#8b5cf6", animation: "Visual node canvas · drag-connect blocks · animated flow particles · execution log · node inspector · Run/Stop", source: "more" },
  { slug: "ai-prompt-builder-card", href: "/components/cards/ai-prompt-builder-card", title: "AI Prompt Builder", category: "AI", icon: Sparkle, accent: "#8b5cf6", animation: "Multi-section prompt editor · variable injection · token counter · temperature/topP/maxTokens sliders · test with streaming", source: "more" },
  { slug: "ai-model-comparison-card", href: "/components/cards/ai-model-comparison-card", title: "Model Comparison Table", category: "AI", icon: Sparkle, accent: "#8b5cf6", animation: "Side-by-side model comparison · animated benchmark bar charts · feature matrix · pricing calculator with sliders", source: "more" },
  { slug: "ai-generation-result-card", href: "/components/cards/ai-generation-result-card", title: "AI Generation Result", category: "AI", icon: Sparkle, accent: "#8b5cf6", animation: "Streaming output · thinking animation · text/image/code tabs · citations panel · confidence score · regenerate", source: "more" },
  ...
  // ── Backgrounds ──
  { slug: "aurora-mesh-bg-card", href: "/components/cards/aurora-mesh-bg-card", title: "Aurora Mesh", category: "Backgrounds", icon: ImageIcon, accent: "#8b5cf6", animation: "Animated gradient blobs · floating aurora effect · multi-color blend · smooth drift", source: "more" },
  { slug: "particle-constellation-bg-card", href: "/components/cards/particle-constellation-bg-card", title: "Particle Constellation", category: "Backgrounds", icon: ImageIcon, accent: "#8b5cf6", animation: "Canvas particles · auto-connecting lines · proximity detection · drifting motion", source: "more" },
  { slug: "liquid-metal-bg-card", href: "/components/cards/liquid-metal-bg-card", title: "Liquid Metal", category: "Backgrounds", icon: ImageIcon, accent: "#a0a0a0", animation: "SVG blob morph · rotating ellipses · metallic gradient shift · blur filter", source: "more" },
  { slug: "geometric-grid-bg-card", href: "/components/cards/geometric-grid-bg-card", title: "Geometric Grid", category: "Backgrounds", icon: ImageIcon, accent: "#6366f1", animation: "Isometric grid pattern · pulse circles · moving background · tech aesthetic", source: "more" },
  { slug: "neon-wave-bg-card", href: "/components/cards/neon-wave-bg-card", title: "Neon Wave", category: "Backgrounds", icon: ImageIcon, accent: "#00ffff", animation: "SVG sine waves · neon glow filter · multi-layer animation · cyberpunk", source: "more" },
  { slug: "floating-orbs-bg-card", href: "/components/cards/floating-orbs-bg-card", title: "Floating Orbs", category: "Backgrounds", icon: ImageIcon, accent: "#8b5cf6", animation: "3D perspective orbs · radial glow · depth movement · multi-color floating", source: "more" },
  { slug: "matrix-rain-bg-card", href: "/components/cards/matrix-rain-bg-card", title: "Matrix Rain", category: "Backgrounds", icon: ImageIcon, accent: "#00ff41", animation: "Canvas character rain · Japanese katakana · trail fade · classic matrix", source: "more" },
  { slug: "gradient-mesh-bg-card", href: "/components/cards/gradient-mesh-bg-card", title: "Gradient Mesh", category: "Backgrounds", icon: ImageIcon, accent: "#ec4899", animation: "Conic gradient rotation · dual layer blur · color spectrum · smooth blend", source: "more" },
  { slug: "dot-matrix-bg-card", href: "/components/cards/dot-matrix-bg-card", title: "Dot Matrix", category: "Backgrounds", icon: ImageIcon, accent: "#8b5cf6", animation: "Dot grid pattern · click to ripple · expanding rings · interactive", source: "more" },
  { slug: "starfield-bg-card", href: "/components/cards/starfield-bg-card", title: "Starfield", category: "Backgrounds", icon: ImageIcon, accent: "#ffffff", animation: "Canvas warp speed · star trails · perspective depth · space travel", source: "more" },
  { slug: "bokeh-lights-bg-card", href: "/components/cards/bokeh-lights-bg-card", title: "Bokeh Lights", category: "Backgrounds", icon: ImageIcon, accent: "#ec4899", animation: "Blurred floating circles · multi-color bokeh · soft glow · dreamy", source: "more" },
  { slug: "topographic-bg-card", href: "/components/cards/topographic-bg-card", title: "Topographic", category: "Backgrounds", icon: ImageIcon, accent: "#10b981", animation: "SVG contour lines · elevation map · animated paths · survey aesthetic", source: "more" },
  { slug: "holographic-bg-card", href: "/components/cards/holographic-bg-card", title: "Holographic", category: "Backgrounds", icon: ImageIcon, accent: "#ff00ff", animation: "Iridescent gradient shift · shine sweep · multi-blend · rainbow hologram", source: "more" },
  { slug: "vortex-spiral-bg-card", href: "/components/cards/vortex-spiral-bg-card", title: "Vortex Spiral", category: "Backgrounds", icon: ImageIcon, accent: "#8b5cf6", animation: "Canvas spiral particles · hue rotation · trail lines · hypnotic swirl", source: "more" },
  { slug: "crystal-shards-bg-card", href: "/components/cards/crystal-shards-bg-card", title: "Crystal Shards", category: "Backgrounds", icon: ImageIcon, accent: "#06b6d4", animation: "Rotating polygons · gradient fills · glow filter · gemstone aesthetic", source: "more" },
  { slug: "lava-lamp-bg-card", href: "/components/cards/lava-lamp-bg-card", title: "Lava Lamp", category: "Backgrounds", icon: ImageIcon, accent: "#ff00ff", animation: "Rising metaball blobs · blur filter · vertical drift · retro lamp", source: "more" },
  { slug: "cyber-grid-bg-card", href: "/components/cards/cyber-grid-bg-card", title: "Cyber Grid", category: "Backgrounds", icon: ImageIcon, accent: "#00ffff", animation: "Perspective grid · scrolling floor · sun glow · scanlines · synthwave", source: "more" },
  { slug: "origami-folds-bg-card", href: "/components/cards/origami-folds-bg-card", title: "Origami Folds", category: "Backgrounds", icon: ImageIcon, accent: "#8b5cf6", animation: "Floating paper planes · 3D rotation · gradient fills · light aesthetic", source: "more" },
  { slug: "mesh-gradient-bg-card", href: "/components/cards/mesh-gradient-bg-card", title: "Mesh Gradient", category: "Backgrounds", icon: ImageIcon, accent: "#8b5cf6", animation: "Apple-style dynamic mesh · multi-point radial gradients · noise overlay · smooth shift", source: "more" },
  { slug: "aurora-borealis-bg-card", href: "/components/cards/aurora-borealis-bg-card", title: "Aurora Borealis", category: "Backgrounds", icon: ImageIcon, accent: "#10b981", animation: "Northern lights ribbons · starfield · SVG blur filter · multi-layer wave animation", source: "more" },
  { slug: "noise-texture-bg-card", href: "/components/cards/noise-texture-bg-card", title: "Noise Texture", category: "Backgrounds", icon: ImageIcon, accent: "#64748b", animation: "Film grain · dual-layer fractal noise · soft-light blend · vignette · premium depth", source: "more" },
  { slug: "animated-grid-glow-bg-card", href: "/components/cards/animated-grid-glow-bg-card", title: "Grid Spotlight", category: "Backgrounds", icon: ImageIcon, accent: "#8b5cf6", animation: "Mouse-follow spotlight · dual glow · cursor dot · grid pattern · interactive", source: "more" },
  { slug: "floating-code-bg-card", href: "/components/cards/floating-code-bg-card", title: "Floating Code", category: "Backgrounds", icon: ImageIcon, accent: "#3b82f6", animation: "Code snippets in 3D space · monospace · colored borders · dev portfolio aesthetic", source: "more" },
  { slug: "network-graph-bg-card", href: "/components/cards/network-graph-bg-card", title: "Network Graph", category: "Backgrounds", icon: ImageIcon, accent: "#3b82f6", animation: "Force-directed nodes · pulsing particles · connection lines · D3-style visualization", source: "more" },
  { slug: "color-audio-bars-bg-card", href: "/components/cards/color-audio-bars-bg-card", title: "Audio Bars", category: "Backgrounds", icon: ImageIcon, accent: "#a855f7", animation: "Equalizer waveform · 48 animated bars · hue gradient · mirror reflection · music app", source: "more" },
  { slug: "glassmorphism-blur-bg-card", href: "/components/cards/glassmorphism-blur-bg-card", title: "Glassmorphism", category: "Backgrounds", icon: ImageIcon, accent: "#f093fb", animation: "Frosted glass tiles · backdrop-blur · moving colored blobs · shimmer animation", source: "more" },
  { slug: "particle-vortex-bg-card", href: "/components/cards/particle-vortex-bg-card", title: "Particle Vortex", category: "Backgrounds", icon: ImageIcon, accent: "#06b6d4", animation: "300 particle tornado · oscillating radius · trail lines · hue rotation · 3D depth", source: "more" },
  { slug: "gradient-waves-bg-card", href: "/components/cards/gradient-waves-bg-card", title: "Gradient Waves", category: "Backgrounds", icon: ImageIcon, accent: "#8b5cf6", animation: "Stripe-style layered SVG waves · 5 gradient layers · smooth motion · filled base", source: "more" },
  // ── Data & Utility ──
