...
export const cardRoutes: CardMeta[] = [
  ...
  { slug: "slider-range-card", href: "/components/cards/slider-range-card", title: "Range Slider", category: "Forms", icon: ChevronDown, accent: "#8b5cf6", animation: "Accessible dual, single, and stepped sliders", source: "more" },
  { slug: "radio-card-group-card", href: "/components/cards/radio-card-group-card", title: "Radio Card Group", category: "Forms", icon: Check, accent: "#3b82f6", animation: "Keyboard radio cards + icon tiles + billing period", source: "more" },
  ...
  { slug: "select-dropdown-card", href: "/components/cards/select-dropdown-card", title: "Select Dropdown", category: "Forms", icon: ChevronDown, accent: "#2563eb", animation: "Portal select + cascading fields + searchable combobox", source: "more" },
  ...
  { slug: "date-time-picker-card", href: "/components/cards/date-time-picker-card", title: "Date & Time Picker", category: "Forms", icon: ChevronDown, accent: "#0ea5e9", animation: "Calendar grid + time stepper + date range", source: "more" },
  { slug: "rich-text-editor-card", href: "/components/cards/rich-text-editor-card", title: "Rich Text Editor", category: "Forms", icon: Mail, accent: "#8b5cf6", animation: "Safe Markdown + formatting toolbar + slash commands", source: "more" },
  ...
  { slug: "dropdown-menu-card", href: "/components/cards/dropdown-menu-card", title: "Dropdown Menu", category: "Forms", icon: ChevronDown, accent: "#2563eb", animation: "Action, preference, and nested portal menus", source: "more" },
  ...
  { slug: "tooltip-card", href: "/components/cards/tooltip-card", title: "Tooltip", category: "Forms", icon: Search, accent: "#64748b", animation: "Portal tooltips on hover and keyboard focus", source: "more" },
  { slug: "progress-bar-card", href: "/components/cards/progress-bar-card", title: "Progress Bar", category: "Forms", icon: Check, accent: "#10b981", animation: "Controlled linear, circular, and checkout progress", source: "more" },
  ...
  // ── Data & Utility ──
  { slug: "enterprise-data-grid-card", href: "/components/cards/enterprise-data-grid-card", title: "Commerce Operations Grid", category: "Tables", icon: Layers, accent: "#6366f1", animation: "Saved operational views · KPI summary · advanced filters · column controls · row density · selection · inline status updates · expandable intelligence · CSV export · pagination · responsive light/dark", source: "more" },
  { slug: "data-table-card", href: "/components/cards/data-table-card", title: "Team Directory Data Table", category: "Tables", icon: Layers, accent: "#6366f1", animation: "Production search · status filters · accessible sorting · selection · bulk actions · CSV export · pagination · quick member creation · responsive light/dark", source: "more" },
  ...
  { slug: "compact-table-card", href: "/components/cards/compact-table-card", title: "Compact Density Table", category: "Tables", icon: Layers, accent: "#6366f1", animation: "High-density professional rows · search · accessible sort · premium surfaces · horizontal safety · light/dark", source: "more" },
  { slug: "expandable-rows-table-card", href: "/components/cards/expandable-rows-table-card", title: "Expandable Detail Table", category: "Tables", icon: Layers, accent: "#8b5cf6", animation: "Keyboard-accessible disclosures · account context · semantic relationships · responsive detail grid · light/dark", source: "more" },
  { slug: "inline-editable-table-card", href: "/components/cards/inline-editable-table-card", title: "Validated Inline Edit Table", category: "Tables", icon: Layers, accent: "#06b6d4", animation: "Explicit cell editing · email and numeric validation · keyboard save/cancel · accessible status feedback · light/dark", source: "more" },
  { slug: "card-table-switcher-card", href: "/components/cards/card-table-switcher-card", title: "Adaptive Table & Cards", category: "Tables", icon: Layers, accent: "#f59e0b", animation: "User-controlled table/card presentation · responsive card grid · search · rich record summaries · light/dark", source: "more" },
  { slug: "financial-table-card", href: "/components/cards/financial-table-card", title: "Market Intelligence Table", category: "Tables", icon: Layers, accent: "#10b981", animation: "Watchlist interactions · market KPIs · top-mover sorting · tabular finance values · accessible sparklines · light/dark", source: "more" },
  { slug: "column-toggle-table-card", href: "/components/cards/column-toggle-table-card", title: "Column Management Table", category: "Tables", icon: Layers, accent: "#ec4899", animation: "Accessible column visibility · minimum-column guard · search and status filters · premium responsive layout · light/dark", source: "more" },
  { slug: "tree-table-card", href: "/components/cards/tree-table-card", title: "Organization Tree Grid", category: "Tables", icon: Layers, accent: "#a855f7", animation: "Semantic treegrid · nested ownership · expand/collapse all · hierarchy search · keyboard-ready disclosures · light/dark", source: "more" },
  { slug: "virtual-scroll-table-card", href: "/components/cards/virtual-scroll-table-card", title: "Virtualized Audit Grid", category: "Tables", icon: Layers, accent: "#3b82f6", animation: "5,000 deterministic events · TanStack virtualization · ResizeObserver sizing · bounded DOM · filters · light/dark", source: "more" },
  { slug: "enterprise-table-card", href: "/components/cards/enterprise-table-card", title: "Pinned Enterprise Table", category: "Tables", icon: Layers, accent: "#64748b", animation: "Pinned identity column · stable zebra surfaces · wide-data scrolling · sorting · production CSV export · light/dark", source: "more" },
  { slug: "responsive-table-card", href: "/components/cards/responsive-table-card", title: "Responsive Records Table", category: "Tables", icon: Layers, accent: "#14b8a6", animation: "Preview-container aware · semantic desktop table · touch-friendly mobile cards · search · sorting · light/dark", source: "more" },
  { slug: "inventory-table-card", href: "/components/cards/inventory-table-card", title: "Inventory Control Table", category: "Tables", icon: Layers, accent: "#0ea5e9", animation: "Warehouse inventory · stock health · reservations · reorder thresholds · working replenishment actions · custom filters · light/dark", source: "more" },
  { slug: "permissions-matrix-table-card", href: "/components/cards/permissions-matrix-table-card", title: "Permissions Matrix Table", category: "Tables", icon: Layers, accent: "#8b5cf6", animation: "Role access matrix · protected admin policy · keyboard-ready permission toggles · custom scope menu · light/dark", source: "more" },
  { slug: "invoice-ledger-table-card", href: "/components/cards/invoice-ledger-table-card", title: "Invoice Ledger Table", category: "Tables", icon: Layers, accent: "#10b981", animation: "Receivables KPIs · invoice status filtering · row selection · mark-paid workflow · CSV export · light/dark", source: "more" },
  { slug: "comparison-matrix-table-card", href: "/components/cards/comparison-matrix-table-card", title: "Plan Comparison Matrix", category: "Tables", icon: Layers, accent: "#f59e0b", animation: "Feature comparison · sticky capability labels · billing switch · plan emphasis · conversion actions · responsive light/dark", source: "more" },
];
