...
export function InsightBentoDashboard() {
  let cardIndex = 0;
  const nextDelay = () => Math.min((cardIndex++ % 12) * 0.045, 0.5);
  return (
    <div className="insight-dashboard min-h-full w-full bg-canvas dark:bg-ink-950">
      <div className="px-4 py-4 md:px-6 md:py-6">
        ...
        <div className="masonry columns-1 sm:columns-2 lg:columns-3 xl:columns-4">
          ...
          <BentoCard delay={nextDelay()}>
            ...
            <Legend items={[{ label: "Data one", color: "#ec1e79" }, { label: "Data two", color: "#4c2ea8" }]} />
            <div className="mt-2">
              <BarSeries
                data={D.verticalBarTwo}
                keys={[{ key: "one", color: "#ec1e79" }, { key: "two", color: "#4c2ea8" }]}
                height={150}
                barSize={9}
          ...
          <BentoCard delay={nextDelay()}>
            ...
            <BarSeries
              ...
              keys={[
                { key: "purple", color: "#4c2ea8" },
                { key: "yellow", color: "#f7c948" },
                { key: "pink", color: "#ec1e79" },
              ]}
              stacked
              height={150}
              barSize={14}
          ...
          <BentoCard delay={nextDelay()}>
            ...
            <div className="mt-4">
              <RankBars
                items={D.horizontalDecline.map((h, i) => ({ ...h, color: `rgba(236,30,121,${1 - i * 0.16})` }))}
                height={11}
                gap={9}
              />
            </div>
          ...
          <BentoCard delay={nextDelay()}>
            ...
            <div className="mb-3 flex flex-wrap gap-2">
              {["2016", "2017", "2018", "2019"].map((y, i) => (
                <Pill key={`${y}-${i}`} active={i === 1} color="#c81d8f">{y}</Pill>
              ))}
            </div>
          ...
          <BentoCard delay={nextDelay()}>
            ...
            <div className="flex justify-center">
              <Donut
                data={[
                  { name: "Cleared", value: 73, color: "#ec1e79" },
                  { name: "Pending", value: 15, color: "#f7c948" },
                  { name: "Delayed", value: 12, color: "#4c2ea8" },
                ]}
                centerLabel="73%"
                size={148}
                thickness={16}
          ...
          <BentoCard delay={nextDelay()}>
            ...
            <LineSeries data={D.tempThemeLine} keys={[{ key: "v", color: "#ec1e79" }]} showAxis height={140} fallback={<ChartFallback height={140} />} />
          </BentoCard>
          ...
          <BentoCard delay={nextDelay()}>
            ...
            <LineSeries
              data={D.winSpeedLine}
              keys={[{ key: "a", color: "#3b6cf4" }, { key: "b", color: "#22d3ee" }]}
              showAxis
              height={130}
          ...
          <BentoCard delay={nextDelay()}>
            ...
            <div className="mt-2 flex items-center gap-2">
              <div className="flex-1">
                <InlineProgress value={83} color="#ec1e79" height={9} />
              </div>
              <span className="text-[11px] font-bold text-ink-500 dark:text-ink-300 whitespace-nowrap">MAX/83%</span>
            </div>
            <div className="mt-2">
              <LineSeries data={D.jennyLine} keys={[{ key: "v", color: "#ec1e79" }]} showAxis height={130} fallback={<ChartFallback height={130} />} />
            </div>
          ...
          <BentoCard delay={nextDelay()}>
            ...
            <div className="mt-2">
              <LineSeries data={D.earningsLine} keys={[{ key: "v", color: "#ec1e79" }]} height={110} fallback={<ChartFallback height={110} />} />
            </div>
          </BentoCard>
          ...
          <BentoCard delay={nextDelay()}>
            <div className="mb-2 flex items-center justify-between">
              ...
              <span className="rounded-full bg-brand-blue px-2.5 py-1 text-[11px] font-bold text-white">+2.45%</span>
            </div>
            <LineSeries data={D.expectedEarningsSpark} keys={[{ key: "v", color: "#3b6cf4" }]} height={110} fallback={<ChartFallback height={110} />} />
          </BentoCard>
          ...
          <BentoCard delay={nextDelay()}>
            ...
            <AreaSeries data={D.monthlyRainfall} keys={[{ key: "v", color: "#22d3ee" }]} height={130} fallback={<ChartFallback height={130} />} />
          </BentoCard>
          ...
          <BentoCard delay={nextDelay()}>
            ...
            <LineSeries data={D.screenReadersLine} keys={[{ key: "v", color: "#3b6cf4" }]} showAxis height={140} fallback={<ChartFallback height={140} />} />
          </BentoCard>
          ...
          <BentoCard delay={nextDelay()}>
            ...
            <div className="mt-2 flex flex-wrap gap-2 text-[11px] text-ink-500 dark:text-ink-300">
              {["24h", "1d", "3d", "1w", "3w", "1m"].map((t, i) => (
                <Pill key={`${t}-${i}`} active={t === "3d"} color="#ec1e79">{t}</Pill>
              ))}
            </div>
          </BentoCard>
          ...
          <BentoCard delay={nextDelay()}>
            ...
            <Legend items={[{ label: "Zone one", color: "#221a4d" }, { label: "Zone two", color: "#22d3ee" }]} />
            <div className="mt-2">
              <LineSeries
                data={D.windSpeedDual}
                keys={[{ key: "zoneOne", color: "#221a4d" }, { key: "zoneTwo", color: "#22d3ee" }]}
                height={120}
          ...
          <BentoCard delay={nextDelay()}>
            ...
            <LineSeries
              ...
              keys={[{ key: "one", color: "#3b6cf4" }, { key: "two", color: "#ec1e79" }]}
              showAxis
              height={140}
              fallback={<ChartFallback height={140} />}
            />
            <p className="mt-3 text-xs text-ink-500 dark:text-ink-300">Minim dolor in amet nulla laboris enim dolore consequatt.</p>
            <Legend items={[{ label: "Data one", color: "#3b6cf4" }, { label: "Data two", color: "#ec1e79" }]} />
          </BentoCard>
          ...
          <BentoCard delay={nextDelay()}>
            ...
            <BarSeries data={D.contributionsBars5y} keys={[{ key: "v", color: "#e6e8f0" }]} showAxis height={110} barSize={20} fallback={<ChartFallback height={110} />} />
            <div className="-mx-5 -mb-5 mt-3 rounded-b-card bg-emerald-50 dark:bg-emerald-500/10 px-5 pb-5 pt-3">
              ...
              <AreaSeries data={D.contributionsAreaTrend} keys={[{ key: "v", color: "#22c55e", opacity: 0.5 }]} height={90} fallback={<ChartFallback height={90} />} />
            </div>
          </BentoCard>
          ...
          <BentoCard delay={nextDelay()}>
            ...
            <WaveStack
              ...
              keys={[{ key: "a", color: "#c81d8f" }, { key: "b", color: "#7c3aed" }, { key: "c", color: "#f6c6de" }]}
              height={140}
              fallback={<ChartFallback height={140} />}
            />
            <div className="mt-2 flex items-center justify-between">
              <div className="flex -space-x-1">
                {["#c81d8f", "#7c3aed", "#f6c6de", "#4c2ea8"].map((c, i) => (
          ...
          <BentoCard delay={nextDelay()}>
            ...
            <Legend items={[{ label: "2010", color: "#ec1e79" }, { label: "2011", color: "#7c3aed" }, { label: "2012", color: "#22d3ee" }]} />
            <div className="mt-2">
              <BarSeries
                data={D.historicPopulation}
                keys={[
                  { key: "y2010", color: "#ec1e79" },
                  { key: "y2011", color: "#7c3aed" },
                  { key: "y2012", color: "#22d3ee" },
                ]}
                height={150}
                barSize={6}
                fallback={<ChartFallback height={150} />}
          ...
          <BentoCard delay={nextDelay()}>
            <ProfileRow
              ...
              action={
                <div className="flex items-center gap-1 text-xs font-bold text-emerald-500">
                  34.56
                  <LineSeries data={D.densityTrend} keys={[{ key: "v", color: "#22c55e" }]} height={22} fallback={<div className="h-[22px] w-12" />} />
                </div>
              }
            />
            ...
            <div className="flex justify-center">
              <MultiRing
                rings={[
                  { value: 98, color: "#3b6cf4" },
                  { value: 74, color: "#22d3ee" },
                  { value: 52, color: "#c81d8f" },
                ]}
                centerLabel="98%"
                centerSub="Browser"
                size={140}
          ...
          <BentoCard delay={nextDelay()}>
            ...
            <LineSeries
              ...
              keys={[{ key: "usd", color: "#3b6cf4" }, { key: "eur", color: "#ec1e79" }]}
              showAxis
              height={140}
              fallback={<ChartFallback height={140} />}
            />
          ...
          <BentoCard delay={nextDelay()}>
            <div className="mb-2 flex items-center justify-between">
              ...
              <LineSeries data={D.densityTrend} keys={[{ key: "v", color: "#4c2ea8" }]} height={20} fallback={<div className="h-[20px] w-16" />} />
            </div>
            <BarSeries
              data={D.appleBananaBars}
              keys={[{ key: "apple", color: "#4c2ea8" }, { key: "banana", color: "#f7c948" }]}
              showAxis
              height={140}
              barSize={10}
              fallback={<ChartFallback height={140} />}
            />
            <div className="mt-2">
              <Legend items={[{ label: "Apple", color: "#4c2ea8" }, { label: "Banana", color: "#f7c948" }]} />
            </div>
          ...
          <BentoCard delay={nextDelay()}>
            ...
            <div className="flex justify-center">
              <RadialGauge value={70} size={150} thickness={14} color="#f5a623" label="70%" />
            </div>
            <h3 className="mt-4 text-center text-[17px] font-bold text-ink-900 dark:text-white">My storage</h3>
            <div className="mt-4 flex items-center justify-between text-xs">
              <span className="flex items-center gap-1.5 text-ink-500 dark:text-ink-300"><Dot color="#f5a623" />Used</span>
              <span className="flex items-center gap-1.5 text-ink-500 dark:text-ink-300"><Dot color="#e6e8f0" />Total space</span>
              <button className="rounded-full bg-amber-400 px-3 py-1.5 text-[11px] font-bold text-white">BUY MORE</button>
            </div>
          </BentoCard>
          ...
          <BentoCard delay={nextDelay()} className="bg-ink-900 dark:bg-gradient-to-br dark:from-ink-800 dark:to-ink-900" accent="linear-gradient(90deg,#ec1e79,#7c3aed)">
              ...
              {(["America", "Europe", "Asia"] as const).map((r, i) => (
                <span
                  ...
                  className={`rounded-full px-3 py-1 text-[11px] font-bold ${
                    i === 0 ? "bg-brand-violet text-white" : "text-white/50"
                  }`}
                >
                  {r}
                </span>
            ...
            <div className="mt-3">
              <AreaSeries
                ...
                keys={[{ key: "v", color: "#a78bfa", opacity: 0.6 }]}
                height={130}
                fallback={<ChartFallback height={130} />}
              />
            </div>
