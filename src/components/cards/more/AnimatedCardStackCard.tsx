...
export function AnimatedCardStackCard() {
  ...
  return (
    <div className="flex min-h-full w-full flex-col items-center justify-center bg-background pt-2">
      <h1 className="mb-8 text-2xl font-bold text-foreground">Infinite card stack</h1>
