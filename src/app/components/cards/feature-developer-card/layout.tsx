...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/components/cards/feature-developer-card" },
  openGraph: {
    type: "website",
    url: "/components/cards/feature-developer-card",
    title: "Developer Features – Features React Component",
    description: "Developer Features is a production-ready features React component featuring Terminal theme + code blocks + syntax highlight + CLI feature cards. Copy,…",
...
const structuredData = {
  ...
  "description": "Developer Features is a production-ready features React component featuring Terminal theme + code blocks + syntax highlight + CLI feature cards. Copy,…",
  "url": "https://www.mtverse.dev/components/cards/feature-developer-card",
  "programmingLanguage": [
    "TypeScript",
    "React",
    "CSS"
