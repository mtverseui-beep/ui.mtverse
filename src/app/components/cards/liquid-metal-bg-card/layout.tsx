...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/components/cards/liquid-metal-bg-card" },
  openGraph: {
    type: "website",
    url: "/components/cards/liquid-metal-bg-card",
    title: "Liquid Chrome – Backgrounds React Component",
    description: "Liquid Chrome is a production-ready backgrounds React component featuring Controlled metallic halo · luxury product lighting · reduced-motion safe. Copy,…",
...
const structuredData = {
  ...
  "name": "Liquid Chrome",
  "description": "Liquid Chrome is a production-ready backgrounds React component featuring Controlled metallic halo · luxury product lighting · reduced-motion safe. Copy,…",
  "url": "https://www.mtverse.dev/components/cards/liquid-metal-bg-card",
  "programmingLanguage": [
    "TypeScript",
    "React",
    "CSS"
