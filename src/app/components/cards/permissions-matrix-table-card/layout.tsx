...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/components/cards/permissions-matrix-table-card" },
  openGraph: {
    type: "website",
    url: "/components/cards/permissions-matrix-table-card",
    title: "Permissions Matrix Table – Tables React Component",
    description: "Permissions Matrix Table is a production-ready tables React component featuring Role access matrix · protected admin policy · keyboard-ready permission…",
...
const structuredData = {
  ...
  "description": "Permissions Matrix Table is a production-ready tables React component featuring Role access matrix · protected admin policy · keyboard-ready permission…",
  "url": "https://www.mtverse.dev/components/cards/permissions-matrix-table-card",
  "programmingLanguage": [
    "TypeScript",
    "React",
    "CSS"
