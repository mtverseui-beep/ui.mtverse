...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/components/cards/cta-dual-action-card" },
  openGraph: {
    type: "website",
    url: "/components/cards/cta-dual-action-card",
    title: "Dual Action CTA – CTA React Component",
    description: "Dual Action CTA is a production-ready cta React component featuring Two side-by-side CTA buttons + comparison. Copy, customize, and use it in Next.js…",
...
const structuredData = {
  ...
  "description": "Dual Action CTA is a production-ready cta React component featuring Two side-by-side CTA buttons + comparison. Copy, customize, and use it in Next.js…",
  "url": "https://www.mtverse.dev/components/cards/cta-dual-action-card",
  "programmingLanguage": [
    "TypeScript",
    "React",
    "CSS"
