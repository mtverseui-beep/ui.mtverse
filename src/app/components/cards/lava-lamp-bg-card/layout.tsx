...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/components/cards/lava-lamp-bg-card" },
  openGraph: {
    type: "website",
    url: "/components/cards/lava-lamp-bg-card",
    title: "Organic Gradient – Backgrounds React Component",
    description: "Organic Gradient is a production-ready backgrounds React component featuring Calm organic color fields · lifestyle hero composition · no metaball loop.…",
...
const structuredData = {
  ...
  "description": "Organic Gradient is a production-ready backgrounds React component featuring Calm organic color fields · lifestyle hero composition · no metaball loop.…",
  "url": "https://www.mtverse.dev/components/cards/lava-lamp-bg-card",
  "programmingLanguage": [
    "TypeScript",
    "React",
    "CSS"
