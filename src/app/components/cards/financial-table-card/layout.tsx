...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/components/cards/financial-table-card" },
  openGraph: {
    type: "website",
    url: "/components/cards/financial-table-card",
    title: "Market Intelligence Table – Tables React Component",
    description: "Market Intelligence Table is a production-ready tables React component featuring Watchlist interactions · market KPIs · top-mover sorting · tabular finance…",
...
const structuredData = {
  ...
  "description": "Market Intelligence Table is a production-ready tables React component featuring Watchlist interactions · market KPIs · top-mover sorting · tabular finance…",
  "url": "https://www.mtverse.dev/components/cards/financial-table-card",
  "programmingLanguage": [
    "TypeScript",
    "React",
    "CSS"
