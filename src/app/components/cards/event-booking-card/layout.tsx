...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/components/cards/event-booking-card" },
  openGraph: {
    type: "website",
    url: "/components/cards/event-booking-card",
    title: "Event Booking – Product React Component",
    description: "Event Booking is a production-ready product React component featuring Ticket stub + RSVP. Copy, customize, and use it in Next.js projects.",
...
const structuredData = {
  ...
  "name": "Event Booking",
  "description": "Event Booking is a production-ready product React component featuring Ticket stub + RSVP. Copy, customize, and use it in Next.js projects.",
  "url": "https://www.mtverse.dev/components/cards/event-booking-card",
  "programmingLanguage": [
    "TypeScript",
    "React",
    "CSS"
