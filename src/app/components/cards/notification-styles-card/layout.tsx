...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/components/cards/notification-styles-card" },
  openGraph: {
    type: "website",
    url: "/components/cards/notification-styles-card",
    title: "Notification Center – Data React Component",
    description: "Notification Center is a production-ready data React component featuring Priority filter + reveal. Copy, customize, and use it in Next.js projects.",
...
const structuredData = {
  ...
  "description": "Notification Center is a production-ready data React component featuring Priority filter + reveal. Copy, customize, and use it in Next.js projects.",
  "url": "https://www.mtverse.dev/components/cards/notification-styles-card",
  "programmingLanguage": [
    "TypeScript",
    "React",
    "CSS"
